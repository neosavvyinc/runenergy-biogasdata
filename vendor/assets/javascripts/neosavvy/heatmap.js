...
(function(w){
    ...
    heatmap.prototype = {
		...
		drawLabeledPoints: function(points) {
                var me = this,
                    ctx = me.get("ctx");

				var LABEL_MARGIN_BOTTOM = 6;
				var LABEL_MARGIN_RIGHT_PER_CHAR = 3;
				...
				for(var i=0; i < points.length; i++) {
					...
					// The funny math here on the label coordinates approximates
					// center align over the labeled point
					ctx.strokeText(point.label, point.x-(LABEL_MARGIN_RIGHT_PER_CHAR*point.label.length), point.y-LABEL_MARGIN_BOTTOM);
				}
